...
/* Unable to complete some of the above due to a 403 error. Any required concatenations or conversions failed on the springboard site.
...
/* I'd like to work through these with a mentor. I found them to be quite the difficulty spike.
